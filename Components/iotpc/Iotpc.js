        ...
        <>
                ...
                <div className="row">
                  <div className="col-md-8">
                    ...
                    <div className="col-md-12 bg_card_4 text-center">
                      <img
                        className="img-fluid pt-5"
                        src="https://1864597015.rsc.cdn77.org/selteq/images/i2.png"
                      />
                      <div className="text-left  pt-4 mt-2 px-2">
                        <p className="font_card_text">
                        ...
                        <p className="font_subtext">
                          The real-time streaming of data generated by IoT
                          devices that quickly process the data and respond to
                  ...
                  <div className="col-md-3">
                    <div className="col-md-12 bg_card_4 text-center">
                      <img
                        className="img-fluid pt-5"
                        src="https://1864597015.rsc.cdn77.org/selteq/images/i3.png"
                      />
                      <div className="text-left  pt-4 mt-2 px-2">
                        <p className="font_card_text">
                        ...
                        <p className="font_subtext">
                          Integrating IoT devices with third-party services and
                          APIs that leverage other platforms capabilities to
                          enhance the functionality of the IoT devices &
                          systems.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="col-md-3">
                    <div className="col-md-12 bg_card_4 text-center">
                      <img
                        className="img-fluid pt-5"
                        src="https://1864597015.rsc.cdn77.org/selteq/images/i4.png"
                      />
                      <div className="text-left  pt-4 mt-2 px-2">
                        <p className="font_card_text">
                        ...
                        <p className="font_subtext">
                          Implementing security & privacy measures that include
                          encryption, access controls, & secured data storage to
          ...
          <div className="col-md-12 background_s4 px-5">
                ...
                <div className="col-md-10">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-10 px-0">
                      ...
                      <p className="sub_des">
                        Helps prevent unauthorised access to data while it's in
                        transit. It includes regular security testing to ensure
            ...
            {props?.object?.Section6_detail ? (
              <div className="col-md-12 padding_top_s6  text-right">
                  ...
                  <div className="row">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-10 px-0">
                        ...
                        <p className="sub_des">
                          Helps prevent unauthorised access to data while it's
