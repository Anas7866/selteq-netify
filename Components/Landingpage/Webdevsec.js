                        ...
                        <div className="row">
                            <div className="col-md-12  m-auto pt-5">
                                <div className="col-md-12 text-light p-0 ">
                                    ...
                                    <h6 data-aos="fade-left text-start" >We’re a global provider of web development services specializing in creating data-driven websites to increase conversion, usability and customer satisfaction. We take pride in our work and understand the value of attention to detail; because your end product must be able to deliver your message, even if it’s the only thing on your website visitors see.</h6>
                                </div>
